    ...
    <form class="was-validated" action="/post?<?= $data["num"] ?>/update_post" method="post">
        <div class="form-row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" value="<?= $data["title"] ?>" name="title" maxlength="100"
                       required>
            </div>
            <div class="col-md-6 mb-3">
                <label for="validationServer02">Краткое описание</label>
                <input type="text" class="form-control" value="<?= $data["lemma"] ?>" name="lemma" maxlength="140"
                       required>
            </div>
        </div>
